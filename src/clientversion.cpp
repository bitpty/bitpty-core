...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Bitpty Core") == std::string::npos) {
        strCopyrightHolders += "\nCopyright (C) 2025. The Bitpty Core developers.\nDerived from Bitcore.";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://www.bitpty.org/>";
