...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 9772, 9334);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 19772, 18334);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 49772, 48334);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 39772, 38334);
